...
const getVideoComments = asyncHandler(async (req, res) => {
    ...
    //pipeline
        //match on video id
        //get data commenter name and comment content, 
        // like count of that comment, 
        // if I have liked that comment flag
        //$newfields for above and $project
    //then apply pagination and limit and return data to frontend
...
const addComment = asyncHandler(async (req, res) => {
    ...
    const comment = await Comment.create({content:content, owner:req.user?._id, video:videoId})
